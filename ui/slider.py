...
class Slider:                        
    ...
    def draw(self, screen):
        ...
        pygame.draw.rect(screen,self.col,self.slider, border_radius=5)
        # додай рамку
        pygame.draw.rect(screen,BLACK,self.slider,width = 20)

        # намалюй сам повзунок
        pygame.draw.rect(screen, self.pointer,self.col_pointer,border_radius=5)
        # додай рамку повзунка
        pygame.draw.rect(screen,BLACK,self.col_pointer,width = 20)
        
        # обчисли позицію тексту по X : 
        #х.поінтера + ширина повзунка // 2.6
        x = self.pointer.x + self.slider.w
        # обчисли позицію тексту по Y : 
        #у.поінтера + ширина повзунка // 3
        y = self.pointer.y+ self.slider.h//3
