...
class SettingsMenu:                 
    def __init__(self,x,y,w,h,col_btn,col_txt,col_slider): 
        ...
        self.btn_open = Button(x,y,w,h,col_btn,"Settings",col_txt,command= self.open_menu,image="assets/image/buttons/settings_hover.p")
        # створи кнопку повернення назад
        # координати, розмір, кольри - з конструктора класу, 
        # текст -"Back" , 
        # команда - закрити меню
        self.btn_close = Button(x,y,w,h,col_btn,"Back",col_txt,command= self.close_menu,image="assets/image/buttons/exit_hover.p")
