...
class SettingsMenu:                 
    def __init__(self,x,y,w,h,col_btn,col_txt,col_slider): 
        ...
        self.txt_volume = Button(x,y,w,h,color=col_btn,text="Volume",color_text=BLACK,command=None)
        ...
        self.txt_num_keys = Button(x,y,w,h,color=col_btn,text="Num keys",color_text=BLACK,command=None)
